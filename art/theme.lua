...
if not LibEKL.Art then LibEKL.Art = {} end

local nkArt   = LibEKL.Art

---------- init local variables ---------

local _activeTheme = 'default'
local _themes = { default = { logo              = {'LibEKL', 'gfx/nkUILogo.png'},
                ...
                bw              = { logo              = {'LibEKL', 'gfx/nkUILogo.png'},
                  ...
                  nkUI = {  logo = {'LibEKL', 'gfx/nkUILogo.png'},
