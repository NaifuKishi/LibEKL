...
local function _uiCombobox(name, parent) 
	...
	--local elementColor = LibEKL.art.GetThemeColor("elementMainColor")
	--local elementColorInner = LibEKL.art.GetThemeColor("elementSubColor")
	--local selectedColor = LibEKL.art.GetThemeColor("highlightColor")
	...
	for idx = 1, 5, 1 do
		...
		selItemFrame:EventAttach(Event.UI.Input.Mouse.Left.Click, function ()
			...
			LibEKL.eventHandlers[name]["ComboChanged"](selValue)
