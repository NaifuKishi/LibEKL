...
local function buildinternalFuncColorPicker ()
...
local function _uiColorPicker(name, parent) 
	...
	colorDisplay:EventAttach(Event.UI.Input.Mouse.Left.Click, function ()
		...
		if _uiGlobalColorPicker == nil then buildinternalFuncColorPicker() end
		...
		if _uiGlobalColorPicker:GetVisible() == true and pickerShown == true then
			...
			Command.Event.Attach(LibEKL.events['LibEKL.defaultColorPicker'].ColorChanged, function (_, r, g, b, a)				
				...
				LibEKL.eventHandlers[name]["ColorChanged"]( r, g, b, 1 )		
			end, "LibEKL.defaultColorPicker.ColorChanged")
		end		
